""" ParserJS: análisis sintáctico y semántico con Ply.yacc
"""
...
class Scope():
    """clase que gestiona los alcances de las variables y el nombre de la función"""
    def __init__(self):
        if len(listScope) > 1:
...
def parse(program):
    ...
    import re
    program = re.sub(r";+",";",program) # permitir múltiples; como en javascript
    # terminar en una estructura con un ; , reemplazamos todas las apariciones de ;\n con \n
