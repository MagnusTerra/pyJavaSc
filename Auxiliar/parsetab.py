...
_lr_productions = [
  ...
  ('new_scope -> <empty>','new_scope',0,'p_new_scope','parserJS.py',29),
  ('program -> NEWLINE program','program',2,'p_newline_program','parserJS.py',39),
  ('program -> statement ; NEWLINE','program',3,'p_program','parserJS.py',43),
  ('program -> statement NEWLINE','program',2,'p_program','parserJS.py',44),
  ('program -> statement ; program','program',3,'p_program_recursive','parserJS.py',48),
  ('program -> statement NEWLINE program','program',3,'p_program_recursive','parserJS.py',49),
  ('programBlock -> { new_scope program }','programBlock',4,'p_program_block','parserJS.py',53),
  ('programBlock -> NEWLINE programBlock','programBlock',2,'p_newline_program_block','parserJS.py',58),
  ('caseProgram -> : new_scope program','caseProgram',3,'p_case_program','parserJS.py',62),
  ('programStatement -> statement','programStatement',1,'p_program_statement','parserJS.py',67),
  ('statement -> NEWLINE statement','statement',2,'p_newline_statement','parserJS.py',72),
  ('statement -> assignation','statement',1,'p_statement','parserJS.py',76),
  ('statement -> structure','statement',1,'p_statement','parserJS.py',77),
  ('statement -> structureIf','statement',1,'p_statement','parserJS.py',78),
  ('statement -> structureTernary','statement',1,'p_statement','parserJS.py',79),
  ('statement -> logStatement','statement',1,'p_statement','parserJS.py',80),
  ('statement -> breakStatement','statement',1,'p_statement','parserJS.py',81),
  ('statement -> continueStatement','statement',1,'p_statement','parserJS.py',82),
  ('statement -> functionDeclaration','statement',1,'p_statement','parserJS.py',83),
  ('statement -> functionCall','statement',1,'p_statement','parserJS.py',84),
  ('statement -> returnStatement','statement',1,'p_statement','parserJS.py',85),
  ('statement -> varList','statement',1,'p_statement','parserJS.py',86),
  ('structureIf -> IF ( condition ) programStatement NEWLINE','structureIf',6,'p_if','parserJS.py',90),
  ('structureIf -> IF ( condition ) programBlock','structureIf',5,'p_if','parserJS.py',91),
  ('structureElse -> ELSE programStatement','structureElse',2,'p_else','parserJS.py',95),
  ('structureElse -> ELSE programBlock','structureElse',2,'p_else','parserJS.py',96),
  ('structure -> structureIf structureElse','structure',2,'p_if_else','parserJS.py',100),
  ('structureTernary -> condition ? returnValues : returnValues','structureTernary',5,'p_ternary_operator','parserJS.py',104),
  ('structure -> FOR new_scope ( assignation ; condition ; assignation ) programBlock','structure',10,'p_for','parserJS.py',108),
  ('structure -> FOR new_scope ( assignation ; condition ; assignation ) programStatement','structure',10,'p_for','parserJS.py',109),
  ('structure -> WHILE ( condition ) programStatement','structure',5,'p_while','parserJS.py',114),
  ('structure -> WHILE ( condition ) programBlock','structure',5,'p_while','parserJS.py',115),
  ('structure -> DO programBlock WHILE ( condition )','structure',6,'p_do_while','parserJS.py',119),
  ('structure -> DO programStatement NEWLINE WHILE ( condition )','structure',7,'p_do_while_without_bracket','parserJS.py',123),
  ('structure -> SWITCH ( IDENTIFIER ) { new_scope caseList }','structure',8,'p_case_pro','parserJS.py',127),
  ('structure -> SWITCH ( IDENTIFIER ) { }','structure',6,'p_switch_void','parserJS.py',139),
  ('caseList -> NEWLINE caseList','caseList',2,'p_newline_case_list','parserJS.py',147),
  ('caseStructure -> CASE expression caseProgram','caseStructure',3,'p_case','parserJS.py',151),
  ('caseList -> caseStructure','caseList',1,'p_case_list','parserJS.py',155),
  ('caseStructure -> DEFAULT caseProgram','caseStructure',2,'p_default','parserJS.py',159),
  ('caseList -> caseList NEWLINE caseStructure','caseList',3,'p_case_list_recursive_newline','parserJS.py',163),
  ('caseList -> caseList caseStructure','caseList',2,'p_case_list_recursive','parserJS.py',167),
  ('conditionSymbol -> LT','conditionSymbol',1,'p_conditionSymbol','parserJS.py',171),
  ('conditionSymbol -> GT','conditionSymbol',1,'p_conditionSymbol','parserJS.py',172),
  ('conditionSymbol -> LTE','conditionSymbol',1,'p_conditionSymbol','parserJS.py',173),
  ('conditionSymbol -> GTE','conditionSymbol',1,'p_conditionSymbol','parserJS.py',174),
  ('conditionSymbol -> EQUALV','conditionSymbol',1,'p_conditionSymbol','parserJS.py',175),
  ('conditionSymbol -> EQUALVT','conditionSymbol',1,'p_conditionSymbol','parserJS.py',176),
  ('conditionSymbol -> NOTEQUALV','conditionSymbol',1,'p_conditionSymbol','parserJS.py',177),
  ('conditionSymbol -> NOTEQUALVT','conditionSymbol',1,'p_conditionSymbol','parserJS.py',178),
  ('condition -> ! condition','condition',2,'p_condition_not','parserJS.py',183),
  ('condition -> condition AND condition','condition',3,'p_condition_and','parserJS.py',187),
  ('condition -> condition OR condition','condition',3,'p_condition_or','parserJS.py',191),
  ('condition -> expression conditionSymbol expression','condition',3,'p_condition','parserJS.py',195),
  ('condition -> ( condition )','condition',3,'p_condtition_paren','parserJS.py',199),
  ('breakStatement -> BREAK','breakStatement',1,'p_break','parserJS.py',203),
  ('continueStatement -> CONTINUE','continueStatement',1,'p_continue','parserJS.py',207),
  ('logStatement -> LOG ( returnValues )','logStatement',4,'p_log','parserJS.py',211),
  ('varCreation -> VAR IDENTIFIER','varCreation',2,'p_var_creation','parserJS.py',215),
  ('varCreation -> LET IDENTIFIER','varCreation',2,'p_var_creation','parserJS.py',216),
  ('varList -> varCreation','varList',1,'p_var_creation_list','parserJS.py',225),
  ('varList -> varList , IDENTIFIER','varList',3,'p_var_creation_list_recursive','parserJS.py',229),
  ('arrayDeclaration -> [ ]','arrayDeclaration',2,'p_array_empty','parserJS.py',238),
  ('arrayDeclaration -> [ tokenList ]','arrayDeclaration',3,'p_array_declaration','parserJS.py',242),
  ('tokenList -> IDENTIFIER','tokenList',1,'p_token_list','parserJS.py',246),
  ('tokenList -> NUMBER','tokenList',1,'p_token_list','parserJS.py',247),
  ('tokenList -> tokenList , IDENTIFIER','tokenList',3,'p_token_list_recursive','parserJS.py',251),
  ('tokenList -> tokenList , NUMBER','tokenList',3,'p_token_list_recursive','parserJS.py',252),
  ('expression -> IDENTIFIER [ NUMBER ]','expression',4,'p_array_access','parserJS.py',256),
  ('expression -> NUMBER','expression',1,'p_expression_num','parserJS.py',277),
  ('expression -> IDENTIFIER','expression',1,'p_expression_var','parserJS.py',281),
  ('expression -> ( expression )','expression',3,'p_expression_paren','parserJS.py',289),
  ('expression -> expression ADD_OP expression','expression',3,'p_expression_op','parserJS.py',293),
  ('expression -> expression MUL_OP expression','expression',3,'p_expression_op','parserJS.py',294),
  ('expression -> ADD_OP expression','expression',2,'p_minus','parserJS.py',298),
  ('assignation -> IDENTIFIER ADD_OP = expression','assignation',4,'p_expression_op_assignation','parserJS.py',302),
  ('assignation -> IDENTIFIER MUL_OP = expression','assignation',4,'p_expression_op_assignation','parserJS.py',303),
  ('assignation -> IDENTIFIER ADD_OP = functionCall','assignation',4,'p_expression_op_assignation','parserJS.py',304),
  ('assignation -> IDENTIFIER MUL_OP = functionCall','assignation',4,'p_expression_op_assignation','parserJS.py',305),
  ('assignation -> IDENTIFIER ADD_OP ADD_OP','assignation',3,'p_expression_op_assign_double','parserJS.py',313),
  ('assignation -> IDENTIFIER = returnValues','assignation',3,'p_assign','parserJS.py',325),
  ('assignation -> varList = returnValues','assignation',3,'p_creation_assignation','parserJS.py',333),
  ('assignation -> varList = structureTernary','assignation',3,'p_creation_assignation','parserJS.py',334),
  ('functionDeclaration -> FUNCTION IDENTIFIER ( new_scope argList ) programBlock','functionDeclaration',7,'p_function_creation','parserJS.py',338),
  ('functionDeclaration -> FUNCTION IDENTIFIER ( ) programBlock','functionDeclaration',5,'p_function_creation_without_arg','parserJS.py',348),
  ('argList -> IDENTIFIER','argList',1,'p_arglist','parserJS.py',357),
  ('argList -> argList , IDENTIFIER','argList',3,'p_arglist_recursive','parserJS.py',364),
  ('functionCall -> IDENTIFIER ( expressionList )','functionCall',4,'p_function_call','parserJS.py',375),
  ('functionCall -> IDENTIFIER ( )','functionCall',3,'p_function_call_withous_args','parserJS.py',389),
  ('expressionList -> expression','expressionList',1,'p_expression_list','parserJS.py',402),
  ('expressionList -> expressionList , expression','expressionList',3,'p_expression_list_recursive','parserJS.py',406),
  ('returnStatement -> RETURN','returnStatement',1,'p_return','parserJS.py',410),
  ('returnStatement -> RETURN returnValues','returnStatement',2,'p_return_expression','parserJS.py',414),
  ('returnStatement -> RETURN condition','returnStatement',2,'p_return_expression','parserJS.py',415),
  ('returnValues -> expression','returnValues',1,'p_return_values','parserJS.py',419),
  ('returnValues -> arrayDeclaration','returnValues',1,'p_return_values','parserJS.py',420),
  ('returnValues -> functionCall','returnValues',1,'p_return_values','parserJS.py',421),
]
